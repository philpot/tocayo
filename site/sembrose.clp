...
<option value="1">extremely similar</option>
<option value="2">very similar</option>
<option value="3">somewhat similar</option>
<option value="5">similar</option>
<option value="all">[return all names]</option>
</select>
